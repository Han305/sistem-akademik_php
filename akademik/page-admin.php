...
<body>
    ...
    <?php 
        include('koneksi.php');
        $no = 1;
        $query = mysqli_query($koneksi,"SELECT * FROM post where id='1'");
        while ($row = $query->fetch_assoc()) {
    ?>
    <div class="mb-4 card">
        <div class="card-body small">
            <a class="text-decoration-none" href="post-admin.php">Back </a> / <span class="text-muted"><?php echo $row['title'] ?></span>
        </div>
    </div>
